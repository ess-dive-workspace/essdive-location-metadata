...
## At a minimum, report required terms below in a csv with the term names in the first row. Name the file “locations.csv” or with a prefix in the form of “*_locations.csv)
### location_id
...
2. Use the `alt_coordinate_*` term for coordinates in other reference systems. See Instructions: `alt_coordinate_*` for more details.
...
## Include as many optional terms as relevant to your dataset. Note that some terms are conditionally required.
